...
Cтоимость маршрутов от маршрутизатора R1 для 192.168.3.0/24 равна 65535 так даннаная сетка находиться за S1/3(а стоимость данного канала
65535), а для 192.168.23.0/30 рассчитана как сумма  двух каналов(либо от R1 и R2 если рассматривать со стороны S1/2) то есть 
65535+6476.
